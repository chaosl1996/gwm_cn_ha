...
async def async_setup_entry(
    ...
    async_add_entities(
        [
            # ---- 找车 ----
            GWMRemoteButton(coordinator, config_entry, "鸣笛找车", "horn", CMD_WHISTLE, "mdi:bullhorn"),
            GWMRemoteButton(coordinator, config_entry, "闪灯找车", "flash", CMD_FLASH, "mdi:lightbulb-flash"),
            GWMRemoteButton(coordinator, config_entry, "鸣笛+闪灯", "horn_flash", CMD_WHISTLE_FLASH, "mdi:alarm-light-outline"),
            # ---- 门窗补救 ----
            GWMRemoteButton(
            ...
            GWMRemoteButton(
                ...
                "mdi:car-roof", cmd_body={"skyLight": 0},
            ),
            # ---- 远程启动(燃油车按需启动发动机) ----
            GWMRemoteButton(
            ...
            # ---- 座椅加热(开=10 分钟,3 档值;关:operationMode 1=加热) ----
            GWMRemoteButton(
